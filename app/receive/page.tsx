...
import { QuickReceive } from '@/src/components/QuickReceive'
                ...
                <div className="w-full max-w-xl">
                    <div className="mb-4 md:mb-6">
                        ...
                        <p className="text-sm md:text-base text-muted-foreground">
                            Enter the share code to download files or view text
                        </p>
                    </div>
                    ...
                    <Card className="p-4 md:p-6">
                        {!transfer ? (
                            ...
                            <div className="space-y-4">
                                ...
                                {transfer.transfer.contentType === 'text' ? (
                                    <QuickReceive
                                        textContent={transfer.transfer.textContent || ''}
                                        metadata={transfer.transfer.textMetadata}
                                        shareCode={code}
                                    />
                                ) : (
                                    <>
